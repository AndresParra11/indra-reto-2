        ...
        <div className="d-xl-flex align-items-center">
          ...
          <div className="file-field">
            <div className="d-flex justify-content-xl-center ms-xl-3">
              <div className="d-flex iconPaper">
                <span className="icon icon-md iconPaper">
                  <FontAwesomeIcon
                    icon={faPaperclip}
                    className="me-3 iconPaper"
                  />
                </span>
                <input type="file" />
                <div className="d-md-block text-start">
                  <div className="fw-normal text-dark mb-1">Escoger Foto</div>
                  <div className="text-gray small">
                    JPG, GIF ó PNG. Max tamaño de 800K
                  </div>
                </div>
              </div>
            </div>
...
SalesValueWidgetPhone.propTypes = {
  title: PropTypes.string,
  value: PropTypes.string,
  percentage: PropTypes.number,
};
